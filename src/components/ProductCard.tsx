        ...
        <CardContent className="p-0">
          ...
          <div className="relative aspect-square overflow-hidden bg-[var(--cream)]">
            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <span className="px-6 py-3 bg-white/95 text-sm tracking-[0.1em] font-medium transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 hover:bg-[var(--gold)] hover:text-[var(--navy)]">
                QUICK VIEW
              </span>
            </div>
          </div>
